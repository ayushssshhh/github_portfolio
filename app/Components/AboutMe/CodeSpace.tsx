...
import linkedIn1 from '@/public/linkendin1.png'
        ...
        <div className='flex relative md:pl-10'>
            ...
            <div className='lg:pl-24 md:pl-16 pl-6'>
                <div className='flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row'>
                    ...
                    <div className='py-4 lg:mt-[250px] w-full'>
                        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: 0.2, type: "spring" }} className='md:pr-6'>
                            <h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">Connect with me on
                                <span className='font-semibold text-white'> LinkedIn</span>  to explore innovative web app projects, AI-powered solutions, and collaborative opportunities. 🚀</h2>
                            <a target='_blank' onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.linkedin.com/in/kumar-ayush-3b8a27240/" className='py-1 inline-block text-xl text-white font-semibold'>
                    ...
                    <div className=' w-full'>
                        <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween", delay: 0.1 }} className='mb-10 md:mb-32 pb-4 '>
                            <div className='py-4 text-left'>
                                ...
                                <h3 className="text-[#7ee787] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">30% increase</h3>
                                <p className="mb-3 md:text-xl text-base font-medium text-white">in developers productivity who<br /> collaborate with other developers</p>
                            </div>
                        </motion.div>
                        <div className='relative'>
                            <div className='flex flex-row relative sm:mt-[150px]'>
                                <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween" }} className='sm:absolute z-[1] top-[-200px] right-7 shadow-2xl'>
                                    <div className='shadow-[10px_10px_20px_black] shadow-[10px_10px_20px_black]  rounded-[10px] relative sm:translate-y-[30%]'>
                                        <Image src={linkedIn2} alt="" loading="lazy" decoding="async" className="w-[400px] h-auto rounded-md" />
                                    </div>
                                ...
                                <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween", delay: 0.1 }} className=" overflow-hidden max-w-[373px] bottom-0 rounded-md relative hidden sm:block build-in-animate" >
                                    <div className='shadow-[10px_10px_20px_black] rounded-[10px]'>
                                        <Image
                                            src={linkedIn1}
                                            loading="lazy"
                                            width="746"
                                            ...
                                            alt=""
                                            decoding="async"
                                            className="width-full d-block h-auto rounded-md"
                                        />
                                    </div>
                                </motion.div>
                            </div>
                ...
                <div id="project">
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ type: "tween", delay: 0.1 }} className='mb-10 md:mb-32 pb-4 '>
                        <div className='py-4 text-left'>
                            ...
                            <h3 className="text-[#7ee787] mb-2 mt-3 lg:text-8xl md:text-7xl text-5xl font-medium">PDFlex</h3>
                            <p className="mt-3 md:text-xl text-base font-medium text-white">Intoducing, An Ai Powered PDF Chatbot </p>
                        </div>
                    </motion.div>
                </div>
            </div>
