...
import drone from '@/public/hero-drone.png'
...
const Hero = (props: Props) => {
    ...
    return (
        <div className='relative max-w-[1280px] lg:pt-32 md:px-10 mx-auto pt-16'>
            <Image className='absolute hero-drone top-28 w-1/4 h-auto right-0 xl:right-0' width="500" height="326" src={drone} alt="" />
            <div className='flex'>
                <div className='relative '>
                    <img aria-hidden="true" className='' src="https://github.githubassets.com/images/modules/site/home-campaign/lines-hero.svg" width="330" height="637" alt="" />
                    ...
                    <div style={{ background: 'linear-gradient(#d2a8ff, #a371f7 10%, #196c2e 70%, #2ea043 80%, #56d364)', marginLeft: '11px' }} className=" max-md:w-[2px] w-[3px] h-[450px] max-md:h-[400px] max-sm:h-[500px] max-ssm:h-[900px] max-sssm:h-[1150px] line rounded-md"></div>
                </div>
                <div className=' absolute pt-32 mt-28 max-md:px-4 ml-4 md:ml-12'>
                    <div className='relative md:top-20 mb-[24px]'>
                        <a target='_blank' onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} href="https://www.linkedin.com/in/kumar-ayush-3b8a27240/" className=' border-[1px] border-neutral-600 copilot rounded-full inline-block'>
                            <div className='flex items-center p-3 px-5'>
                                ...
                                <div className='md:pr-5 pr-3 md:mr-2 md:pl-2'>
                                    <div className='font-medium text-white text-[16px] max-md:text-[14px] leading-5'>Hey, I am Kumar Ayush</div>
                                    <div className='text-neutral-500 max-md:text-[14px] text-[16px]'>Connect with me on LinkendIn</div>
                                </div>
                    ...
                    <h1 className="md:mt-24 lg:mt-28 sm:mt-10 relative z-2 max-md:mb-5 text-[48px] md:text-[72px] max-sm:leading-[60px] max-md:leading-[80px] lg:text-[80px] font-semibold text-white"> Let&apos;s build Together</h1>
                    <p className="relative z-1 text-[16px] md:text-[20px]  lg:text-[24px] leading-[30px] md:leading-[36px] lg:leading-[44px] mb-5 md:mb-12 md:10/12  lg:w-9/12 text-[#7d8590]">
                        Welcome to my digital playground! As a tech enthusiast with a knack for innovation, I love turning wild ideas into reality. Ready to join forces and create something amazing? Let’s make magic happen.
                    </p>
                    <div className='flex lg:w-11/12 md:space-x-5 max-md:flex-col'>
                        ...
                        <form action="">
                            <div className=' grid max-md:grid-rows-2 md:grid-cols-2'>
                                <dl>
                                    <dd>
                                        <input className='h-12 focus:outline-none max-md:rounded-md md:rounded-s-md right-0 w-full placeholder:text-[16px] pl-3' placeholder="Your message.." type="text" name="msg" id="msg" autoComplete="off" />
                                    </dd>
                                </dl>
                        ...
                        <a target="_blank" onMouseEnter={() => setHovered1(true)} onMouseLeave={() => setHovered1(false)} href="https://docs.google.com/document/d/1TCC6aBDTmzMwPqMwJznKbp0hQBL78ofP/edit?usp=sharing&ouid=104012999880515343774&rtpof=true&sd=true" className='flex items-center w-full md:w-auto justify-center text-[16px] py-3 px-5 max-md:mt-4 rounded-md border-[#ae88f9] border-[1.5px] text-white'>
                            Resume
